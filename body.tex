...
The volume of data within a DR can be estimated based on the inputs to the updated sizing 
model \citedsp{DMTN-135}.  For the purposes of this document we take a DR to be comprised 
